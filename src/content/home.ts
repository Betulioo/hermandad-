...
export const homeFeaturedProducts = [
  {
    ...
    price: "12,00 €",
    description:
      "Medalla oficial en plata de ley con esmalte azul. Incluye cadena.",
    href: "/tienda",
  },
  {
    id: "2",
    ...
    price: "18,00 €",
    description:
      "Historia de la Hermandad desde sus orígenes hasta la actualidad. 320 páginas.",
    href: "/tienda",
  },
  {
    id: "3",
    ...
    price: "15,00 €",
    description:
      "Camiseta de algodón 100 % con el escudo de la Hermandad. Tallas S–XXL.",
    href: "/tienda",
  },
  {
    id: "4",
    ...
    price: "8,00 €",
    description:
      "Escapulario de la Hermandad, bordado a mano sobre tela de seda natural.",
    href: "/tienda",
  },
];
...
export const homeLocationContact = {
  address: " C/ Virgen de la Antigua, nº 9",
  city: "Madrid ",
  phone: "+34 954 000 000",
  email: "antiguavicalvaro@archidiocesis.madrid",
  officeHours: "Lunes a viernes: 10:00 - 13:00 h",
  massScheduleSummary:
    "Laborables: 9:00 · Sábados: 19:00 · Domingos: 12:00 y 20:00",
  mapsUrl: "https://maps.app.goo.gl/c7y62Fqwcz7PAPui7",
  mapsEmbedSrc:
    "https://maps.google.com/maps?q=40.4013837,-3.6049583&z=17&hl=es&output=embed",
};
